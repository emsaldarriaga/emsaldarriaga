...
//app.get('/projects/:region', (req, res)=>{
//	const urlParam = req.params.region;
//	res.render('project', {urlParam : urlParam})
//})
...
//	if (region == "north-america" ||"latin-america" ||"sub-saharan-africa"){
//	res.sendFile(region+".html", { root: './public' });
//	}
//})
//
